    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_private_or_global', models.BooleanField(blank=True, choices=[(True, 'Private'), (False, 'Global')], default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Upload an image for the post.', null=True, upload_to='posts/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_birth_date', models.DateField(blank=True, default=myapp.models.UserprofileFolder.userprofile_model.default_date, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_image_container', models.ImageField(upload_to=myapp.models.UserprofileFolder.userprofile_model.user_directory_path, validators=[myapp.models.UserprofileFolder.userprofile_model.validate_image_file_size])),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('image_subject', models.CharField(blank=True, max_length=25, null=True)),
                ('is_private_or_global', models.BooleanField(blank=True, choices=[(True, 'Private'), (False, 'Global')], default=False, null=True)),
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='myapp.album')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='myapp.userprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
                ...
                ('followerss', models.ForeignKey(help_text='Select the user who is being followed.', on_delete=django.db.models.deletion.CASCADE, related_name='followers', to='myapp.userprofile')),
            ],
        ),
        migrations.AddField(
            model_name='comment',
